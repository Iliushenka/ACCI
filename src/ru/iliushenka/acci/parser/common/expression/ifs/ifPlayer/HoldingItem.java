...
public class HoldingItem extends Action {
    ...
    private static final ArrayList<Parameter> parameters = new ArrayList<>(List.of(
            ...
            new Parameter("switch5", 1, "NUMBER", 49, ParameterAction.CLICK),
            new Parameter("switch6", 1, "NUMBER", 50, ParameterAction.CLICK),
            new Parameter("switch7", 1, "NUMBER", 51, ParameterAction.CLICK),
            new Parameter("switch8", 1, "NUMBER", 52, ParameterAction.CLICK),
            new Parameter("switch9", 1, "NUMBER", 53, ParameterAction.CLICK)
    ));
    private static final String type = "HOLDING_ITEM";
